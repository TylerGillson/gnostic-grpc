[![Go Actions Status](https://github.com/TylerGillson/gnostic-grpc/workflows/Go/badge.svg)](https://github.com/TylerGillson/gnostic-grpc/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/TylerGillson/gnostic-grpc)](https://goreportcard.com/report/github.com/TylerGillson/gnostic-grpc)
...
- Scanning OpenAPI v3 documents for equivalent gRPC service incompatibilities. For simple per file incompatibility scanning see the README file in the [directory](https://github.com/TylerGillson/gnostic-grpc/tree/master/incompatibility). For analysis over a set of OpenAPI documents see the README file in the [directory](https://github.com/TylerGillson/gnostic-grpc/tree/master/analysis).
...
Install gnostic and the plugin before Go 1.17:
    ...
    go get -u github.com/TylerGillson/gnostic-grpc
    

with Go >= 1.17:

    go install github.com/google/gnostic@latest
    go install github.com/TylerGillson/gnostic-grpc@latest
...
## End-to-end example
This [directory](https://github.com/TylerGillson/gnostic-grpc/tree/master/examples/end-to-end) contains a tutorial on how to build a gRPC service that implements an OpenAPI specification.
